...
import com.brokerage.assetservice.domain.command.handler.AssetAggregate;
...
public class AxonConfig {
    ...
    public KafkaPublisher<String, byte[]> kafkaPublisher(@Qualifier("axonProducerFactory") ProducerFactory<String, byte[]> producerFactory) {
        return KafkaPublisher.<String, byte[]>builder()
                ...
                .topicResolver(event -> Optional.of("assertservice-topic-name")) // Example topic resolver
                .build();
    }
